// Package types contains types
//
// This package was derived from the `github.com/docker/cli/cli/compose/types` package,
// and is subject to the Apache 2 license. See https://github.com/docker/cli/blob/master/LICENSE
// to read the license. Modifications were applied to support certain unsupported features
// (e.g. extended services).
package types
...
// ExtensionConfig describes how a service extends another
...
type ServiceConfig struct {
	...
	Extends         *ExtensionConfig                 `yaml:",omitempty"`
